...
RUN = "2026-07-22_10-39-50_CAPTURE_RSI_R2_seed42_RESUME4000_TO5000"
CHECKPOINT = "model_5000.pt"
OUT_DIR = "/home/zero/xiaohai_capture_rsi_eval"
VIDEO = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model5000_PHASE0_Isaac.mp4")
DUMP = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model5000_PHASE0_Isaac_dump.npz")
SUMMARY = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model5000_PHASE0_Isaac_summary.json")
