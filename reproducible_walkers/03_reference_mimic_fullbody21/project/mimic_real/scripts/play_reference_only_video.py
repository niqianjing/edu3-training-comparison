...
def play():
    ...
    # Preserve the original deterministic +2 cm root-height initialization.
    env_cfg.domain_rand.reset_robot_base.params["pose_range"]["z"] = (0.02, 0.02)
    ...
    video_path = "/home/zero/xiaohai_fullbody_eval/Xiaohai_OriginalFullbody_ReferenceOnly_Isaac_viewport.mp4"
