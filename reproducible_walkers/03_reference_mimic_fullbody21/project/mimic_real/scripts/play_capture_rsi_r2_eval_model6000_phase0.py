...
RUN = "2026-07-22_13-54-09_CAPTURE_RSI_R2_seed42_RESUME5000_TO7000"
CHECKPOINT = "model_6000.pt"
OUT_DIR = "/home/zero/xiaohai_capture_rsi_eval"
VIDEO = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model6000_PHASE0_Isaac.mp4")
DUMP = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model6000_PHASE0_Isaac_dump.npz")
SUMMARY = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model6000_PHASE0_Isaac_summary.json")
