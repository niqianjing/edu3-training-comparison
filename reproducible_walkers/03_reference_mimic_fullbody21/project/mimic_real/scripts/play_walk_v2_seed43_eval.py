...
RUN = "2026-07-22_13-22-29_WALKV2_CLEARANCE_R1_seed43"
CHECKPOINT = "model_1000.pt"
OUT_DIR = "/home/zero/xiaohai_walk_v2_eval"
VIDEO = os.path.join(OUT_DIR, "Xiaohai_WalkV2_seed43_model1000_PHASE0_Isaac.mp4")
DUMP = os.path.join(OUT_DIR, "Xiaohai_WalkV2_seed43_model1000_PHASE0_Isaac_dump.npz")
SUMMARY = os.path.join(OUT_DIR, "Xiaohai_WalkV2_seed43_model1000_PHASE0_Isaac_summary.json")
