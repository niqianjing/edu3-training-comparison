...
VIDEO = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model15000_PHASE0_Isaac.mp4")
DUMP = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model15000_PHASE0_Isaac_dump.npz")
SUMMARY = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model15000_PHASE0_Isaac_summary.json")
...
def play():
    ...
    export_policy_as_jit(
        ...
        filename="policy_model15000.pt",
    )
    print("XIAOHAI_JIT_DONE=", os.path.join(export_model_dir, "policy_model15000.pt"), flush=True)
    env.close()
