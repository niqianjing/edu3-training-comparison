...
VIDEO = os.path.join(OUT_DIR, "Xiaohai_model15000_PORTABLE_EXPLICIT_Isaac.mp4")
DUMP = os.path.join(OUT_DIR, "Xiaohai_model15000_PORTABLE_EXPLICIT_Isaac_dump.npz")
SUMMARY = os.path.join(OUT_DIR, "Xiaohai_model15000_PORTABLE_EXPLICIT_Isaac_summary.json")
