...
RUN = "2026-07-22_06-00-06_CAPTURE_RSI_R2_seed42"
CHECKPOINT = "model_1000.pt"
OUT_DIR = "/home/zero/xiaohai_capture_rsi_eval"
VIDEO = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model1000_Isaac.mp4")
DUMP = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model1000_Isaac_dump.npz")
SUMMARY = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model1000_Isaac_summary.json")
