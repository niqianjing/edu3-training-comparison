...
class Sim2simCfg:
    class sim_config:
        mujoco_model_path = '/home/tian/Desktop/pi/mimic_hi/mimic_real/assets/urdf/hi/mjcf/hi_23dof_250425.xml'
        model_path = '/home/tian/Desktop/pi/mimic_real/logs/hi_mimic/2025-05-30_21-22-10/exported/policy.pt'
    ...
    class robot_config:
        ...
        tau_limit = np.array([24.0] + [17.0] * 10 + [24.0] * 12, dtype=np.double)
        use_filter = False
