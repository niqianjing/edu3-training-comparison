...
RUN = "2026-07-22_09-43-33_CAPTURE_RSI_R2_seed42_RESUME2000_TO3000"
CHECKPOINT = "model_3000.pt"
OUT_DIR = "/home/zero/xiaohai_capture_rsi_eval"
VIDEO = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model3000_Isaac.mp4")
DUMP = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model3000_Isaac_dump.npz")
SUMMARY = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model3000_Isaac_summary.json")
