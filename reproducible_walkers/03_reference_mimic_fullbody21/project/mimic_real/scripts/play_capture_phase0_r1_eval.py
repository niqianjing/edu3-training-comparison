...
parser = argparse.ArgumentParser(description="Strict Xiaohai capture-phase0 evaluation")
...
RUN = "2026-07-22_05-17-05_CAPTURE_PHASE0_R1_seed42"
CHECKPOINT = "model_1000.pt"
OUT_DIR = "/home/zero/xiaohai_capture_phase0_eval"
VIDEO = os.path.join(OUT_DIR, "Xiaohai_CapturePhase0_R1_seed42_model1000_Isaac.mp4")
DUMP = os.path.join(OUT_DIR, "Xiaohai_CapturePhase0_R1_seed42_model1000_Isaac_dump.npz")
SUMMARY = os.path.join(OUT_DIR, "Xiaohai_CapturePhase0_R1_seed42_model1000_Isaac_summary.json")
