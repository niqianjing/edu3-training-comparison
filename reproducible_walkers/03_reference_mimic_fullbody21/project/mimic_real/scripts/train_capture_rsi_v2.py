...
parser = argparse.ArgumentParser(description="Train Xiaohai with the isolated V2 clearance reference.")
parser.add_argument("--task", type=str, default="hi_mimic_capture_rsi_v2_clearance")
...
def train():
    ...
    source = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "envs", "mimic"))
    copy_py_files(source, log_dir + "/py")
