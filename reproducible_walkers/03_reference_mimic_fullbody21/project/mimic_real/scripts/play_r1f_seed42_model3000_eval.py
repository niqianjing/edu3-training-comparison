...
def play():
    ...
    agent_cfg.load_run = "2026-07-22_04-25-41_ORIGINAL_FULLBODY_WALK_R1F_seed42_RESUME2000_TO3000"
    # agent_cfg.load_run = "0server"
    agent_cfg.load_checkpoint = "model_3000.pt"
    ...
    export_policy_as_jit(runner.alg.policy, runner.obs_normalizer, path=export_model_dir, filename="policy_walk_seed42_model3000.pt")
    export_policy_as_onnx(runner.alg.policy, normalizer=runner.obs_normalizer, path=export_model_dir, filename="policy_walk_seed42_model3000.onnx")
    ...
    video_path = "/home/zero/xiaohai_fullbody_eval/Xiaohai_OriginalFullbody_seed42_model3000_Isaac_viewport.mp4"
