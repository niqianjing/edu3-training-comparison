...
OUT_DIR = "/home/zero/xiaohai_capture_rsi_eval"
VIDEO = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model10000_PHASE0_Isaac.mp4")
DUMP = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model10000_PHASE0_Isaac_dump.npz")
SUMMARY = os.path.join(OUT_DIR, "Xiaohai_CaptureRSI_R2_seed42_model10000_PHASE0_Isaac_summary.json")
...
def play():
    ...
    export_policy_as_jit(
        ...
        filename="policy_model10000.pt",
    )
    print("XIAOHAI_JIT_DONE=", os.path.join(export_model_dir, "policy_model10000.pt"), flush=True)
    env.close()
