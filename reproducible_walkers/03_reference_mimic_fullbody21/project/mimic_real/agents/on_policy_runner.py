...
import mimic_real.agents  as agents
from mimic_real.agents import PPO, VecEnv
from mimic_real.agents.modules.actor_critic import ActorCritic
from mimic_real.agents.modules.normalizer import EmpiricalNormalization
from mimic_real.agents.utils import store_code_state
...
class OnPolicyRunner:
    ...
    def __init__(self, env: VecEnv, train_cfg: dict, log_dir: str | None = None, device="cpu"):
        ...
        self.disable_logs = False # self.is_distributed and self.gpu_global_rank != 0
        # Logging
    ...
    def load(self, path: str, load_optimizer: bool = True):
        ...
        loaded_dict = torch.load(path, weights_only=False,map_location='cuda:0')
