from mimic_real.envs.base.base_env_config import BaseEnvCfg
import torch
...
from isaaclab.envs.mdp.events import randomize_rigid_body_material, randomize_rigid_body_mass, reset_joints_by_scale, reset_root_state_uniform, push_by_setting_velocity, apply_external_force_torque
...
class BaseEnv(VecEnv):
    ...
    def step(self, actions: torch.Tensor):
        ...
        # cliped_actions[:, -2:] = cliped_actions[:, -2:] * 0.3
        # cliped_actions[:, -2:] = 0.0
