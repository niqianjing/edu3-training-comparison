...
class Picl12ControllerCfg(LeggedRobotCfg):
    ...
    class commands(LeggedRobotCfg.commands):
        ...
        class ranges(LeggedRobotCfg.commands.ranges):
            ...
            dstep_width = [0.14, 0.14]  # [0.2, 0.4] # min max [m]

            lin_vel_x = [-0.3, 0.3]  # [-3.0, 3.0] # min max [m/s]
            lin_vel_y = 0.2  # 1.5   # min max [m/s]
...
class Picl12ControllerRunnerCfg(LeggedRobotRunnerCfg):
    do_wandb = True
    seed = -1
