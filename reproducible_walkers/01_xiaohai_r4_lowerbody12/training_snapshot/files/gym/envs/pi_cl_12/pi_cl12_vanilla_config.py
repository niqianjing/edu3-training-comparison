"""
Configuration file for "fixed arm" (FA) Hicl environment
...
class Picl12VanillaCfg(LeggedRobotCfg):
...
class Picl12VanillaRunnerCfg(LeggedRobotRunnerCfg):
    do_wandb = True
    seed = -1
    ...
    class runner(LeggedRobotRunnerCfg.runner):
        ...
        max_iterations = 1000
        run_name = 'full'
        experiment_name = 'Picl12_Vanilla'
        save_interval = 100
